...
// Feature icons: lucide-react ONLY. Google OAuth button uses official Google logo SVG (brand).
import { useState } from 'react'
import { BarChart2, BookOpen, Brain } from 'lucide-react'
    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="space-y-6">
          {[
            {
              icon: <BookOpen size={18} color="#0BB5AD" />,
              text: 'Board-aligned tutoring for IB, CBSE, ICSE and SSC',
            },
            {
              icon: <Brain size={18} color="#0BB5AD" />,
              text: 'Step-by-step explanations with Deep Dive doubt clearing',
            },
            {
              icon: <BarChart2 size={18} color="#0BB5AD" />,
              text: 'Track your progress and build mastery over time',
            },
          ].map((item, i) => (
